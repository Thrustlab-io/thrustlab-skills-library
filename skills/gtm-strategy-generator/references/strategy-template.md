...
Refer to `plays-index.md` for the complete list of available outbound workflow plays.

Select exactly 3 plays that best fit the client's ICP, sales motion, and available data sources.
